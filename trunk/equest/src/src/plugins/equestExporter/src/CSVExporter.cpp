...
void equestExporter::CSVExporter::exportAnnotations(const utils::Filesystem::Path& path, const AnnotationData& data, const ExportConfig& config) const
{
    exportMeta(path, data, config);
    exportData(path, data, config);
}

void equestExporter::CSVExporter::exportMeta(const utils::Filesystem::Path& path, const AnnotationData& data, const ExportConfig& config) const
{
...
void equestExporter::CSVExporter::exportData(const utils::Filesystem::Path& path, const AnnotationData& data, const ExportConfig& config) const
{
