...
equest::AnnotationStatusManager::AnnotationStatusManager()
{
	refreshData();
	start();
}

//equest::AnnotationStatusManager* equest::AnnotationStatusManager::instance()
//{
...
hmdbCommunication::IHMDBSession * equest::AnnotationStatusManager::getSession(hmdbCommunication::IHMDBShallowCopyContext* srcContext)
{
...
hmdbCommunication::IHMDBShallowCopyContext* equest::AnnotationStatusManager::getShallowCopyContext()
{
...
equest::AnnotationStatusManager::Annotations equest::AnnotationStatusManager::getAnnotations(hmdbCommunication::IHMDBSession * session)
{
	Annotations res;
...
const equest::AnnotationStatusManager::AnnotationData* equest::AnnotationStatusManager::getAnnotationData()
{
...
void equest::AnnotationStatusManager::start()
{
...
void equest::AnnotationStatusManager::refreshData()
{
...
hmdbServices::xmlWsdl::Annotation equest::AnnotationStatusManager::getAnnotationStatus(const std::string& user, int trialId)
{
	std::lock_guard<std::mutex> lock(dataMutex);
